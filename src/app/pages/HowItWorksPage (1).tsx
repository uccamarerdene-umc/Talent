  ...
  const pillars = [
    {
      ...
      description:
        "Talent AI нь зөвхөн баталгаажсан Central Test-ийн дата, баримт бичгийг эх сурвалж болгон ашигладаг. Зохиомол хариултыг бүрэн арилгаж, шинжлэх ухааны үндэслэлтэй хариулт өгнө.",
      icon: Database,
      image:
    ...
    },
    {
      ...
      description:
        "GraphRAG нь энгийн текст хайлт биш, тест үнэлгээний үр дүн, ажлын байр, зан үйлийн хоорондын харилцааг graph бүтцээр илэрхийлж, гүн контекст ойлголт өгдөг.",
      icon: Network,
      image:
