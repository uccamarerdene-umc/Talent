...
export function ServicesPage() {
  ...
  const centralTestPortfolio: TestDetail[] = [
    {
      ...
      questions: "114",
      duration: "25–30",
      language: "Англи Монгол хэлний сонголттой",
      ...
      dimensions: [
        { label: "Өөоийн үзул бодолд тууштай", score: 8 },
        { label: "Хяналт тавьдаг", score: 7 },
        { label: "Стратегийн сэтгэлгээ", score: 9 },
        { label: "Итгэл хүлээлгэдэг", score: 6 },
        { label: "Өөдрөг үзэлтэй", score: 8 },
        { label: "Өөртөө итгэлтэй", score: 7 },
      ],
      applications: [
        {
          icon: Search,
        ...
        },
        {
          ...
          desc: "Удирдах чадамжийг тодорхойлж, зорилтот сургалт төлөвлөнө.",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      questions: "100",
      duration: "20–25",
      language: "Англи Монгол хэдний сонголттой",
      target: "18-аас дээш насны бүх хүмүүст",
      ...
      dimensions: [
        ...
        { label: "Бусдыг ойлгох байдал", score: 8 },
        { label: "Эерэг хандах чадвар", score: 6 },
        { label: "Сэтгэл хөдлөлөө илэрхийлэх чадвар", score: 7 },
      ],
      applications: [
        {
          icon: Brain,
        ...
        },
        {
          ...
          desc: "Бусдыг ойлгох чадвар болон харилцааны ур чадварыг бэхжүүлж, хамтын ажиллагааг дэмжинэ.",
        },
        {
          icon: Zap,
          title: "Гүйцэтгэлийн удирдлага",
          desc: "Стрессийг удирдах, ажлын ачаалалтай үед гүйцэтгэл хадгалах чадварыг хэмжинэ.",
        },
      ],
    },
    {
      ...
      duration: "15–20",
      language: "Англи Монгол хэлний сонголттой",
      target: "Ажмл горилогчид, ажилтнууд, дунд шатны менежерүүд, удирдах ажилтнууд",
      ...
      dimensions: [
        ...
        { label: "Карьер хөгжүүлэх боломж", score: 8 },
        { label: "Хамт олны харилцаа", score: 7 },
        { label: "Цалин урамшуулал", score: 6 },
        { label: "Баталгаат байдал", score: 9 },
        { label: "Эрүүл тэнцвэртэй байдал", score: 7 },
      ],
      applications: [
        {
          icon: TrendingUp,
        ...
        },
        {
          ...
          desc: "Ажлаасаа гарах эрсдэлтэй ажилтнуудыг эрт илрүүлж, тохирох арга хэмжээ авна.",
        },
      ],
    },
    {
      ...
      duration: "8–10",
      language: "Англи Монгол хэлний сонголттой",
      target: "14-өөс дээш насны бүх хүмүүст",
      why: "VOCATION нь Holland загварт суурилж, хувь хүний сонирхол болон ажил мэргэжлийн чиг баримжааг хэмждэг. Карьерын зөвлөгөө, дотоод шилжилт болон дахин давтан сургалтад хамгийн тохиромжтой.",
      dimensions: [
        { label: "Бодит байдлыг баримтлагч", score: 6 },
        { label: "Судлаач", score: 8 },
        { label: "Уран сайхнаар сэтгэдэг", score: 9 },
        { label: "Нийгмийн", score: 7 },
        { label: "Ажил хэрэгч", score: 5 },
        { label: "Стандартыг баримтлагч", score: 6 },
      ],
      applications: [
        {
          icon: Target,
    ...
    },
    {
      ...
      duration: "12–15",
      language: "Англи Монгол хэлний сонголттой",
      target: "Шинэхэн төгсөгч, ажилтан, дунд шатны менежер, хувь хүн",
      ...
      dimensions: [
        { label: "Ятган нөлөөлдөг", score: 7 },
        { label: "Бусдын үзэл бодолд уян хатан ханддаг", score: 8 },
        { label: "Нээлттэй харилцдаг", score: 6 },
        { label: "Аливааг бэлтгэлгүй хийж чаддаг", score: 9 },
        { label: "Ажлыг нэн тэргүүнд тавьдаг", score: 7 },
        { label: "Удирдан чиглүүлэх дуртай", score: 8 },
      ],
      applications: [
        {
          icon: Search,
    ...
    },
    {
      ...
      description:
        "Ажлын байран дээрх ёс зүйн эрсдэл, сөрөг зан үйлийг урьдчилан үнэлж, байгууллагын соёлд нийцэх байдлын түвшинг тогтооно.",
      tag: "ЁС ЗҮЙ",
      image:"/26.png",
      questions: "74",
      duration: "10–15",
      language: "Англи Монгол хэлний сонголттой",
      target: "Бүх шатны, ажилтан, удирдлага",
      why: "ETIX нь ёс зүйн асуудлыг урьдчилан таамаглах боломжийг олгодог тест. Байгууллагын ёс зүйн соёл, хариуцлагын механизм бэхжүүлэхэд чиглэсэн шийдвэрт бодит суурь болдог.",
      dimensions: [
        { label: "Хууль дүрэм журмыг хүндэтгэх", score: 3 },
        { label: "Бусдыг хүндэтгэх", score: 2 },
        { label: "Эрх тэгш байдлыг хүндэтгэх", score: 4 },
        { label: "ҮҮрэг хариуцлагаа ухамсарлах", score: 8 },
        { label: "Эд хөрөнгө, өмчийг хүндэтгэх", score: 7 },
        { label: "Баримтн нотолгоо, үнэнч шударга байдлыг хүндэтгэх", score: 9 },
      ],
      applications: [
        {
          icon: Shield,
        ...
        },
        {
          ...
          desc: "Тохирох хүнийг зөв сонгох боломж олгоно.",
        },
      ],
    },
    {
      ...
      duration: "20–25",
      language: "Англи Монгол хэлний сонголттой",
      target: "Борлуулалтын баг,бизнес хөгжлийн ажилтнууд",
      ...
      dimensions: [
        { label: "Борлуулалт хийх ур чадвар", score: 9 },
        { label: "Бизнес хөгжүүлэх чадвар", score: 8 },
        { label: "Хэрэглэгч чиглэсэн байдал", score: 9 },
        { label: "Хэрэглэгч,харилцагч олж авах чадвар", score: 8 },
        { label: "Дасан зохицох байдал", score: 7 },
        { label: "Хэлэлцэл тохиролцоо хийх чадвар", score: 6 },
      ],
      applications: [
        {
          icon: Target,
        ...
        },
        {
          icon: TrendingUp,
          title: "Гүйцэтгэлийн удирдлага",
          desc: "Борлуулалтын багийн чадамжийг нэмэгдүүлэх сургалт чиглүүлнэ.",
        },
        {
          icon: Zap,
          title: "Борлуулалтын стратеги",
          desc: "Борлуулалтын хэв маягийг ойлгож, борлуулалтын аргачлалыг оновчтой болгоно.",
        },
      ],
    },
    {
      code: "REASONING SPATIAL",
      title: "Орон зай, шалтгаант холбоо хамаарлыu тогтоох оюуны чадамжийн тест",
      description:
      ...
      duration: "16",
      language: "Олон хэлт",
      target: "14-с дээш насны бүх хүмүүст",
      ...
      dimensions: [
        ...
        { label: "Техник", score: 8 },
        { label: "Математик ойлголт", score: 8 },
    ...
    {
      code: "REASONING R",
      title: "Шалтгаант холбоо хамаарлыг тогтоох оюуны чадамжийн тест",
      description:
        "Ажлын байран дээр хурдтай шийдвэр гаргах, шинэ мэдээллийг хүлээн авч боловсруулах, тоон өгөгдөлд дүн шинжилгээ хийх ерөнхий оюуны чадамжийг цогцоор үнэлнэ.",
      tag: "ОЮУНЫ ЧАДАМЖ",
      image:"/28.png",
      questions: "42",
      duration: "35",
      language: "Англи Монгол хэлний сонголттой",
      target: "15-с дээш насны бүх хүмүүст",
      ...
      dimensions: [
        { label: "Логиз сэтгэлгээний чадамж", score: 7 },
        { label: "Тооны чадамж", score: 8 },
        { label: "Хэл ярианы чадамж", score: 9 },
      ],
      applications: [
        {
          icon: Search,
        ...
        },
        {
          ...
          desc: "Дарамтан доор хурдан, оновчтой шийдвэр гаргах чадварыг хэмжинэ.",
        },
      ],
    },
    {
      ...
      duration: "12–15",
      language: "Англи Монгол хэлний сонголттой",
      target: "Бизнес эхрлэгчид, төслийн менежерүүд",
      ...
      dimensions: [
        { label: "Худалдааны чиглэлийн бизнес эрхлэгч", score: 9 },
        { label: "Гарааны бизнеё эрхлэх", score: 8 },
        { label: "Инновацилаг сэтгэлгээ", score: 9 },
        { label: "Стратегийн алсын харааа", score: 8 },
        { label: "Хурдан шийдвэр гаргалт", score: 7 },
        { label: "Зохион бүтээгч бизнес эрхлэгч", score: 7 },
      ],
      applications: [
        {
          icon: Sparkles,
  ...
  const centralValues = [
    {
      icon: Microscope,
      title: "Шинжлэх ухаанаар баталгаажсан сэтгэл зүйн тест үнэлгээ",
      description:
    ...
    },
    {
      ...
      description:
        "Central Test-ийн тест үнэлгээнүүд нь сэтгэл зүйн үнэлгээний стандарт, өгөгдлийн аюулгүй байдлыг чандлан мөрдөж, шинэлэг аргуудыг ашиглан бүтээгдсэн.",
    },
    {
      icon: Users,
  ...
  const services = [
    {
      ...
      title: "Сонгон шалгаруулалт",
      description:
        "Central Test-ийн олон улсын сэтгэл зүйн тест үнэлгээний үр дүн, дата өгөгдлийг GraphRAG-тай хослуулан, ажил горилогчийн ажлын байранд нийцэх эсэхийг богино хугацаанд мэдэх боломжтой.",
      bullets: [
  ...
  const pillars = [
    ...
    },
    {
      ...
      description:
        "Тест үнэлгээний үр дүн, ажлын байрны шаардлага хоорондын харилцааг graph бүтцээр илэрхийлж, хариулт өгдөг.",
      icon: Network,
      image:
    ...
    <div className="min-h-screen bg-white text-[#1A0F3E]">
        ...
        <div className="relative max-w-[1280px] mx-auto px-6 z-10">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="flex items-center gap-3 mb-8">
            ...
            <span className="text-[#FFD6E8] text-xs font-semibold tracking-[0.2em] uppercase">
              Central Test · Talent AI-ийн суурь өгөгдөл
            </span>
          </motion.div>
          ...
          <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.2 }} className="text-xl lg:text-2xl text-white/70 max-w-3xl leading-relaxed font-light mb-12">
            "Central Test" нь ажилтны зан төлөв, хандлага, чадамж, ур чадвар, сэдэлжүүлэлэх хүчин зүйл, сэтгэлгээ ба ажлын хэв маягийг шинжлэх ухаанд суурилсан сэтгэл зүйн тестээр хэмжин тодорхойлж, байгууллагын хүний нөөцийн шийдвэр гаргалтыг бодит өгөгдөлд тулгуурлан дэмжих цогц шийдэл юм.
          </motion.p>
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.3 }} className="flex flex-wrap items-center gap-8">
            ...
            <a href="#tests" className="group inline-flex items-center gap-3 text-white border-b-2 border-[#E63995] pb-2 font-semibold hover:gap-5 transition-all">
              Сэтгэл зүйн тест, үнэлгээнд хамрагдах
      ...
      <section className="bg-white py-24 border-b border-[#EBE7F4]">
        <div className="max-w-[1280px] mx-auto px-6">
          <div className="mb-16">
            <SectionLabel>Central Test</SectionLabel>
          ...
          <div className="mb-16">
            ...
            <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6">
              ...
              <p className="text-[#6B6485] text-lg max-w-md leading-relaxed">
                Олон улсад баталгаажсан сэтгэл зүйн тестийн үр дүнд суурилан тохирох ажилд нь зөв хүнийг сонгож, зөв хөгжүүлээрэй.
              </p>
            </div>
          </div>
        ...
        <div className="relative max-w-[1280px] mx-auto px-6">
          <div className="max-w-4xl">
            ...
            <h2 className="text-4xl lg:text-6xl font-bold text-white tracking-tight leading-tight mb-8">
              Central Test-ийн өгөгдөл дээр GraphRAG-ийг нэмж бид{" "}
            ...
            <p className="text-xl text-white/70 leading-relaxed font-light max-w-3xl">
              2015 оноос хойш Монгол хүмүүсийг Central Test-ийн сэтгэл зүйн тест үнэлгээнд хамруулсан, 40,000 хүний бодит үр дүн, тест бүрийн Technical Manual-ыг GraphRAG технологоор баяжуулан, монгол хэлээр асуухад баталгаажсан хариулт өгдөг систем юм.
            </p>
          </div>
        </div>
      </section>
